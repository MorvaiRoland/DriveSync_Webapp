            ...
            <div className="absolute inset-0 flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                ...
                <div className="absolute top-safe md:top-6 left-4 right-4 flex justify-between items-center pt-4 md:pt-0">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link href={`/cars/${car.id}/edit`} className="inline-flex items-center gap-2 text-slate-300 hover:text-white transition-colors bg-black/20 backdrop-blur-md px-3 md:px-4 py-2 rounded-full border border-white/10 hover:bg-white/10">
