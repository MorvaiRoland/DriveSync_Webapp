...
export default function TermsPage() {
  return (
    <LegalLayout title="Általános Szerződési Feltételek" icon="scale" lastUpdated="2025. december 13.">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-12 mb-4 border-l-4 border-amber-500 pl-4">1. A Szolgáltatás Tárgya</h2>
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-12 mb-4 border-l-4 border-amber-500 pl-4">2. Díjazás és Csomagváltás</h2>
      
      <div className="bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 p-6 rounded-2xl not-prose mb-6">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-12 mb-4 border-l-4 border-amber-500 pl-4">3. Felelősség Kizárása (AI Diagnosztika)</h2>
      
      <div className="flex flex-col gap-4 p-6 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-500/30 rounded-xl mt-4 not-prose">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-12 mb-4 border-l-4 border-amber-500 pl-4">4. Adatvesztés és Rendelkezésre Állás</h2>
      <p className="text-slate-700 dark:text-slate-300">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-12 mb-4 border-l-4 border-amber-500 pl-4">5. Felhasználói Magatartás</h2>
      <p className="text-slate-700 dark:text-slate-300">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-12 mb-4 border-l-4 border-amber-500 pl-4">6. Záró Rendelkezések</h2>
      <p className="text-slate-700 dark:text-slate-300">
      ...
      <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-500 text-sm italic">
