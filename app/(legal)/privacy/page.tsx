...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Adatvédelmi Tájékoztató" icon="shield" lastUpdated="2025. december 13.">
      ...
      <p className="lead text-xl text-slate-700 dark:text-slate-400 border-l-4 border-emerald-500 pl-6 italic mb-10 bg-slate-50 dark:bg-transparent py-4 rounded-r-lg">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-10 font-bold border-b border-slate-200 dark:border-slate-800 pb-2">1. Az Adatkezelő Adatai</h2>
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-10 font-bold border-b border-slate-200 dark:border-slate-800 pb-2">2. A Kezelt Adatok Köre és Célja</h2>
      <p className="text-slate-700 dark:text-slate-300 mt-4">A Szolgáltatás használata során az alábbi adatokat kezeljük:</p>
      ...
      <div className="grid md:grid-cols-2 gap-4 not-prose my-6">
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-md">
              <h3 className="text-slate-900 dark:text-white font-bold mb-2 text-lg">Fiók Adatok</h3>
              <ul className="text-sm text-slate-700 dark:text-slate-400 list-disc pl-4 space-y-1">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-md">
              <h3 className="text-slate-900 dark:text-white font-bold mb-2 text-lg">Jármű Adatok</h3>
              <ul className="text-sm text-slate-700 dark:text-slate-400 list-disc pl-4 space-y-1">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-10 font-bold border-b border-slate-200 dark:border-slate-800 pb-2">3. Mesterséges Intelligencia (AI) Használata</h2>
      <p className="text-slate-700 dark:text-slate-300 mt-4">
      ...
      <ul className="list-disc pl-6 space-y-2 marker:text-amber-500 text-slate-700 dark:text-slate-300 mt-2">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-10 font-bold border-b border-slate-200 dark:border-slate-800 pb-2">4. Adattovábbítás és Adatfeldolgozók</h2>
      <p className="text-slate-700 dark:text-slate-300 mt-4">
      ...
      <ul className="list-disc pl-6 space-y-1 mt-4 text-slate-700 dark:text-slate-300 font-medium">
      ...
      <h2 className="text-2xl text-slate-900 dark:text-white mt-10 font-bold border-b border-slate-200 dark:border-slate-800 pb-2">5. Az Ön Jogai</h2>
      <p className="text-slate-700 dark:text-slate-300 mt-4">Önt megilleti a hozzáférés, a helyesbítés, a törlés ("elfeledtetéshez való jog"), az adatkezelés korlátozása és az adathordozhatóság joga. Jogérvényesítési kérelmét az <a href="mailto:info.dynamicsense@gmail.com" className="text-emerald-700 dark:text-emerald-500 font-bold underline">info.dynamicsense@gmail.com</a> címre küldheti.</p>
      
      <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl mt-6 text-sm text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-transparent font-medium shadow-sm">
